...
public class AccountCreateGUI extends JFrame {
	 ...
	 */
	public AccountCreateGUI(ClientManager man, SotrcClientGUI gui) {
		manager = man;
                initComponents();
	}
	...
	private void submitButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
		...
		if(!Arrays.equals(pass, cpass)) {
			...
			JOptionPane.showMessageDialog(this, "Username be at least length 1", "SOTRC", JOptionPane.ERROR_MESSAGE);
        } else if (usernameString.contains(SotrcProperties.VERIFIED_SUFFIX)) {
            System.out.println("Username contained illegal sequence.");
            JOptionPane.showMessageDialog(this, "Username contained illegal character sequence.", "SOTRC", JOptionPane.ERROR_MESSAGE);
            ...
            int selectedOption = JOptionPane.showConfirmDialog(null,
                      "Please do not create a username based on your real name. \n"
                    + "You will not be able to change your username in the future. \n"
                    + "Are you sure you want to create account with username \"" + usernameString + "\"?\n",
                      "Create Account?",
                JOptionPane.YES_NO_OPTION);
            if (selectedOption == JOptionPane.NO_OPTION) {
                return;
            }
			if(manager.createAccount(usernameString, pass)){
				System.out.println("Account Created Successfully");
				JOptionPane.showMessageDialog(this, "Account Created. Proceed to login.", "SOTRC", JOptionPane.INFORMATION_MESSAGE);
				this.dispose();
			} else {
				System.out.println("Account not created. Try again later");
				JOptionPane.showMessageDialog(this, "Account not created. Try again later", "SOTRC", JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	private void generatePasswordButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_generatePasswordButtonActionPerformed
		...
		if(!validNumber) {
			passLength = 12;
			JOptionPane.showMessageDialog(this, "Please enter an integer value greater than or equal to 8. Setting length to 12", "SOTRC", JOptionPane.INFORMATION_MESSAGE);
		}
